    ...
    do {
        ...
        case 4:
            if (cantidad > 0) {
                ...
                ordenado = 1;
                printf("Contenedores ordenados con Metodo 1 (Heap sort).\n");
            } else {
        ...
        case 6:
            if (cantidad > 0) {
                ...
                ordenado = 1;
                printf("Contenedores ordenados con Metodo 3 (Quick sort).\n");
            } else {
                printf("No hay contenedores para ordenar.\n");
            }
            break;
...
void mostrarMenu(void)
{
    ...
    printf("4. Ordenar contenedores Metodo 1 (Heap sort)\n");
